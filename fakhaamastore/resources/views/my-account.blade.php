                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4">
                        <div class="my-account-tab-menu nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link" onclick="window.location.href='{{ url('login') }}" type="button">Logout</button>
                        </div>
                    </div>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="dashboad" role="tabpanel" aria-labelledby="dashboad-tab">
                                <div class="myaccount-content">
                                    <h3>Dashboard</h3>
                                    <div class="welcome">
                                        <p>Hello, <strong>Alex Tuntuni</strong> (If Not <strong>Tuntuni !</strong><a href="{{ url('login') }}" class="logout"> Logout</a>)</p>
                                    </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Pending</td>
                                                    <td>$3000</td>
                                                    <td><a href="{{ url('my-order-details') }}" class="check-btn sqr-btn ">View</a></td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>July 22, 2018</td>
