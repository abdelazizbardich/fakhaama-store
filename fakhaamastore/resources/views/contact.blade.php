                    ...
                    <div class="offset-lg-6 col-lg-6">
                        <div class="section-title position-relative">
                            ...
                            <p class="m-0" style="max-width: unset;">
                                شكرا لكم لزيارة موقعنا على شبكة الإنترنت. كنا نحب أن نسمع منك. سواء كان لديك سؤال أو اقتراح أو أردت فقط إلقاء التحية ، لا تتردد في التواصل معنا. املأ النموذج أدناه أو أرسل إلينا بريدًا إلكترونيًا على <a href="mailto:{{ config('app.contact_email') }}">{{ config('app.contact_email') }}</a>، وسنعاود الاتصال بك في أقرب وقت ممكن. ونحن نتطلع إلى التواصل مع لكم!
                            </p>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="first_name" placeholder="الاسم الشخصي">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="last_name" placeholder="اللقب">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
