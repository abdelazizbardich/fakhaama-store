            ...
            <div class="row flex-xl-row-reverse">
                ...
                <div class="col-lg-6 col-xl-5">
                    <div class="faq-content">
                        <div class="faq-text-img"><img src="assets/images/photos/faq.webp" width="199"
                                height="169" alt="Image"></div>
                        <h2 class="faq-title">Frequently Questions</h2>
                        <div class="faq-line"></div>
                        <p class="faq-desc">Lorem Ipsum is simply dummy text of the printing and typesetting
                            industry. Lorem has been the industry's standard</p>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div id="collapse1" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <p>Donec mattis finibus elit ut tristique. Nullam tempus nunc eget arcu
                                        ...
                                        ultricies, elit lorem eleifend lorem</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
